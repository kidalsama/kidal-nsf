...
sed -i 's/host: "39.105.87.12" # CI: data.databaseMap.primary.host/host: 172.17.56.181/g' ${CONFIG_PATH}
...
sed -i 's/host: "39.105.87.12" # CI: data.databaseMap.secondary.host/host: 172.17.56.181/g' ${CONFIG_PATH}
